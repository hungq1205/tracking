    ...
    *   recorder.start(scope)       // begin recording alongside image capture
    *   ...
    ...
    */
    class ImuRecorder(
        ...
        fun start(scope: CoroutineScope) {
            ...
            outputFile = File(outputDir, "imu.csv").also { it.parentFile?.mkdirs() }
            writer = BufferedWriter(FileWriter(outputFile))
            writer?.write("timestamp_ns,ax,ay,az,gx,gy,gz\n")
