...
if [ -z "${BASH_VERSION:-}" ]; then
    echo "This script requires bash — run it as 'bash $0' (or './build.sh')," >&2
...
echo "APK: $APK"
echo ""
echo "To install on a connected Android device (can run alongside the real"
echo "client/android app — different applicationId, com.tracking.pixietest):"
echo "  adb install -r $APK"
echo ""
echo "To install and launch:"
echo "  adb install -r $APK && adb shell am start -n com.tracking.pixietest/.MainActivity"
