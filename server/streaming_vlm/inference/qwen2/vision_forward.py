...
from transformers.models.qwen2_vl.modeling_qwen2_vl import logger, apply_rotary_pos_emb_vision
try:
    from transformers.models.qwen2_vl.modeling_qwen2_vl import flash_attn_varlen_func
except ImportError:
