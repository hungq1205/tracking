...
from transformers.models.qwen3_vl.modeling_qwen3_vl import (
    logger, rotate_half, Cache, BaseModelOutputWithPast, repeat_kv,
    _flash_attention_forward, StaticCache, SlidingWindowCache,
    AttentionMaskConverter, make_flex_block_causal_mask, BlockMask,
)
...
def streaming_text_eager_attn_forward(
        ...
        # Qwen3-VL: apply q_norm / k_norm before transpose (per-head normalization)
...
def streaming_text_flash_attn_forward(
        ...
        if output_attentions:
            logger.warning_once(
                "Streaming Qwen3 is using Flash Attention, but `flash attention` does not support `output_attentions=True`. Falling back to the manual attention implementation, "
            )
        ...
        attn_output = _flash_attention_forward(
            ...
            key_states,
            value_states,
            None,  # attention_mask suppressed for streaming
            q_len,
